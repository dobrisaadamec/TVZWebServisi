...
namespace Citus.Education.WebApp.Sample.Web.Controllers
{
    public partial class AdminController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult GetItem()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetItem);
        }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string CvCompetenceCreate = "CvCompetenceCreate";
        ...
        public class ActionNameConstants
        {
            ...
            public const string CvCompetenceCreate = "CvCompetenceCreate";
        ...
        static readonly ActionParamsClass_CvCompetenceCreate s_params_CvCompetenceCreate = new ActionParamsClass_CvCompetenceCreate();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_CvCompetenceCreate CvCompetenceCreateParams { get { return s_params_CvCompetenceCreate; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_CvCompetenceCreate
        {
            public readonly string model = "model";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string CvCompetenceCreate = "~/Views/Admin/CvCompetenceCreate.cshtml";
    ...
    public partial class T4MVC_AdminController : Citus.Education.WebApp.Sample.Web.Controllers.AdminController
    {
        ...
        [NonAction]
        partial void IndexNewOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult IndexNew()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.IndexNew);
            IndexNewOverride(callInfo);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CvCompetenceCreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult CvCompetenceCreate()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CvCompetenceCreate);
            CvCompetenceCreateOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void CvCompetenceCreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Citus.Education.WebApp.Sample.Models.ViewModels.CvCompetenceEditViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult CvCompetenceCreate(Citus.Education.WebApp.Sample.Models.ViewModels.CvCompetenceEditViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CvCompetenceCreate);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            CvCompetenceCreateOverride(callInfo, model);
            return callInfo;
        }

        [NonAction]
        partial void GetItemOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetItem(int id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetItem);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            GetItemOverride(callInfo, id);
            return callInfo;
        }
