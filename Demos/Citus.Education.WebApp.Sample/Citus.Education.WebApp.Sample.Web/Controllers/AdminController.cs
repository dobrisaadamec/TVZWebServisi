...
namespace Citus.Education.WebApp.Sample.Web.Controllers
{
    ...
    public partial class AdminController : Controller
    {
        ...
        public virtual ActionResult IndexNew()
        {
            return View(Views.CvCompetenceCreate);
        }
     ...
     JsonRequestBehavior.AllowGet);
        ...
        public virtual ActionResult CvCompetenceCreate()
        {
            return View();
        }

        [HttpPost]
        public virtual ActionResult CvCompetenceCreate(CvCompetenceEditViewModel model)
        {
            if (ModelState.IsValid)
            {
                CvCompetenceModel editModel = model.TranslateTo<CvCompetenceModel>();
            ...
            return View("CvCompetenceCreate", model);
        }
