...
{
    internal partial class Values : IServiceOperations<CitusEducationWebAppSampleWebAPI>, IValues
    {
        /// <summary>
        ...
        /// </param>
        internal Values(CitusEducationWebAppSampleWebAPI client)
        {
            this._client = client;
        }
        ...
        public async Task<HttpOperationResponse<IList<string>>> GetWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (statusCode == HttpStatusCode.OK)
            {
                ...
                if (responseDoc != null)
                {
                    //resultModel = System.Collections.Specialized.StringCollection.DeserializeJson(responseDoc);
                    //resultModel = JsonConvert.DeserializeObject<List<string>>(responseDoc);
