...
namespace Citus.Education.WebApp.Sample.Web
{
    public static partial class CVExtensions
    {
        ...
        /// Reference to the Citus.Education.WebApp.Sample.Web.ICV.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Citus.Education.WebApp.Sample.Web.Models.CvCompetenceModel>> result = await operations.GetWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
