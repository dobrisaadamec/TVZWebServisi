...
namespace Citus.Education.WebApp.Sample.Web
{
    public partial interface ICV
    {
        ...
        /// Cancellation token.
        /// </param>
        Task<HttpOperationResponse<IList<CvCompetenceModel>>> GetWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken));
